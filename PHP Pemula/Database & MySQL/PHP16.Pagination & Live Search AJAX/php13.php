...
$_SESSION['jumlahData'] = count( table("SELECT * FROM kelas6a") ); // jmenghitung umlah data yang ada di database
...
$tableHome = table("SELECT * FROM kelas6a LIMIT $awalData, $dataDitampilkan");
...
<br>
    ...
    <script src="javascript/ajaxPHP.js"></script>
    </body>
</html>
