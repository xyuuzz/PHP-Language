...
<html lang="en">
    ...
    <body>
        ...
        <a href="tambah10.2.php">Tambah Data Nilai</a> <br><br>
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            ...
            <?php foreach($nilaiKelas6a as $values) { ?>
                <tr>
                    <td> <?= $i ?> </td>
                    <td>
                        <a href="edit10.4.php?id=<?= $values["id"]?>">Edit</a> |
                        <a href="hapus10.3.php?id=<?=$values["id"]; ?>" onclick= "return confirm ('Anda yakin menghapus data ini?')" ; >Hapus</a>   <!-- isi dari onclick berfungsi sebagai konfirmasi data -->
                    </td>
                    <td> <?= $values["fotoSiswa"] ?> </td>
